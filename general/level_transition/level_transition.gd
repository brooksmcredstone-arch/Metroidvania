@tool
@icon("res://metroidvania_project/general/icons/level_transition.svg")
...
func _on_player_entered(_n : Node2D) -> void:
	#Transition to the target area
	SceneManager.transition_to_scene(target_level, target_area_name, get_offset(_n), get_transition_direction())
	pass
