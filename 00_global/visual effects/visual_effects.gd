...
# Create Jump Dust
func _jump_dust(pos : Vector2) ->void:
	var dust : DustEffect = _create_dust_effects(pos)
	dust.start(DustEffect.TYPE.JUMP)
	pass
	
# Create Land Dust
func _land_dust(pos : Vector2) ->void:
	var dust : DustEffect = _create_dust_effects(pos)
	dust.start(DustEffect.TYPE.LAND)
	pass
	
# Create Hit Dust
func _hit_dust(pos : Vector2) ->void:
	var dust : DustEffect = _create_dust_effects(pos)
	dust.start(DustEffect.TYPE.HIT)
	pass


func _hit_particles(pos : Vector2, dir : Vector2, settings : HitParticleSettings) -> void:
